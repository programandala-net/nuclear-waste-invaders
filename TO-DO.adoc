...
- Fix: the mothership is not removed at the end of the attack.
  Solution: If the mothership is visible wait until it's gone before
  displaying the attack report.
