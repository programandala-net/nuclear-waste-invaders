...
- Make `beam-y` a character variable, for speed.
...
- Change the sprite of the invaders that are breaking the wall.
- Rewrite `hit-wall?`: compare the coordinates of the invader and the
  wall. This will be faster.
